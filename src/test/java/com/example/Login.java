...
public class Login {
    public static void log(WebDriver driver) {
        ...
        ExcelReader excelReader = new ExcelReader("D:/Tech/BIONS_Automate.xlsx", "LOGIN");
        Iterator<Row> rowIterator = excelReader.getRowIterator();
        //if true, it means there are more rows to process.
        //If false, it means we've reached the end of the rows.
        ...
        while (rowIterator.hasNext()) {
            ...
            String Environment = getCellStringValue(row, 0);
            String Username = getCellStringValue(row, 1);
            String Password = getCellStringValue(row, 2);
            String PIN = getCellStringValue(row, 3);

            if (Username == null || Password == null || PIN == null|| Environment == null) {
                rowIndex++;
                continue;
            }
...
//            List<WebElement> tutorpuh = driver.findElements(By.xpath("//*[text()='Hide Tutorial']"));
            ...
            } else if (Environment.equals("MOCK")) {
            ...
            if (!menuElements.isEmpty()) {
                ...
                System.out.println("ERROR LOGIN " + Environment);
                driver.quit();
                System.exit(0);
            }
    ...
    private static String getCellStringValue(Row row, int cellIndex) {
        ...
        // Assuming all cell values are String type
